...
func (srv *Server) WithLog() *Server {
	if srv.httpMyService != nil {
		srv.httpMyService = srv.MyService().WithLog()
	}
	return srv
}
...
func (srv *Server) WithTrace() *Server {
	if srv.httpMyService != nil {
		srv.httpMyService = srv.MyService().WithTrace()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	if srv.httpMyService != nil {
		srv.httpMyService = srv.MyService().WithMetrics()
	}
	return srv
}

func (srv *Server) MyService() *httpMyService {
	return srv.httpMyService
}
